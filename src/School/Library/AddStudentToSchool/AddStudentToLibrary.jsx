...
const AddStudentToLibrary = () => {
  ...
  return (
    <>
      <View style={{flex: 1}}>
        <BackHeader title={'Student In Library'} icon={'person'} />
        <View style={styles.headerTitleContainer}>
          <View>
            <Text style={styles.secondaryTitle}>Add Student In Library</Text>
          </View>
...
export default AddStudentToLibrary;
