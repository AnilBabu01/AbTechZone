    ...
    await Promise.all(
      books?.map((item, index) => {
        ...
        enquiryTableList[6].items.push({
          id: index,
          value: moment(item?.addDate).format('DD/MM/YYYY'),
        });
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={styles.headerTitleContainer}>
        <View>
          <Text style={styles.secondaryTitle}>Book List Management</Text>
        </View>
      ...
      <AnimatedFAB
        icon={'plus'}
        onPress={() => navigation.navigate('AdBook')}
        label="Add"
        extended={false}
        color={Colors.white}
        style={[fabStyle]}
