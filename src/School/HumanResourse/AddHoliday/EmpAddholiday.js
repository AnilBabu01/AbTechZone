...
import EmpHolidayFilter from '../../../Component/school/EmpHolidayFilter';
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={styles.headerTitleContainer}>
        <View>
          <Text style={styles.secondaryTitle}>Holiday Management</Text>
        </View>
