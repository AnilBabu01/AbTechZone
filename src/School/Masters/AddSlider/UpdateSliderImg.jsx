...
const UpdateSliderImg = () => {
  ...
  useEffect(() => {
    if (route.params?.data) {
      ...
      setserverImgUrl(route.params?.data?.ImgUrl);
      setImgCaption(route.params?.data?.Dec);
    }
  }, []);


  console.log("is",isdata?.ImgUrl);

  return (
    <View>
      <BackHeader title={'Update Slider'} />
      <ScrollView>
        <View style={styles.enquirymainview}>
          ...
          <View style={styles.mainImg}>
            {PreviewSliderimg || isdata?.ImgUrl ? (
              <>
...
export default UpdateSliderImg;
