  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={styles.headerTitleContainer}>
        <View>
          <Text style={styles.secondaryTitle}>Slider Master</Text>
        </View>
            ...
            <View style={styles.enquirymainview}>
              {enquirylist?.length > 0 &&
                enquirylist?.map((item, index) => {
                  return <CardEnquiry key={index} data={item} index={index} />;
                })}
            </View>
          </>
        )}
      ...
      <AnimatedFAB
        icon={'plus'}
        onPress={() => navigation.navigate('Addsliderimg')}
        label="Add"
        extended={false}
        color={Colors.white}
        style={[fabStyle]}
