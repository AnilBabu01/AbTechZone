...
const AddDesignation = ({navigation}) => {
  ...
  const {designation, loading} = useSelector(state => state.getdesignation);
  ...
  useEffect(() => {
    if (designation) {
      setenquirylist(designation);
      convertdata(designation);
    }
  }, [designation]);
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={styles.headerTitleContainer}>
        <View>
          <Text style={styles.secondaryTitle}>Designation Master</Text>
        </View>
