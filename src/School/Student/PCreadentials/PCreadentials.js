...
const PCreadentials = ({navigation}) => {
    ...
    await Promise.all(
      student?.length > 0 &&
        student?.map((item, index) => {
          ...
          StudentTableList[2].items.push({id: index, value: item.name});
          StudentTableList[3].items.push({id: index, value: item.SrNumber});
          StudentTableList[4].items.push({
            id: index,
            value: item.fathersPhoneNo,
          });
          StudentTableList[5].items.push({
            id: index,
            value: userdata?.data?.CredentailsData?.Parentpassword,
          });
        }),
    );
  ...
  return (
    <>
      <View style={{flex: 1}}>
        <BackHeader title={'Parent Creadentials'} icon={'person'} />
        <View style={styles.headerTitleContainer}>
          <View>
            <Text style={styles.secondaryTitle}>Parent Creadentials</Text>
          </View>
