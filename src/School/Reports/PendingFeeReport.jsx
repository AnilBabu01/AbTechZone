...
import CardEnquiry from './PaidFeeCard';
...
const PendingFeeReport = ({navigation}) => {
  ...
  return (
    <>
      <View style={{flex: 1}}>
        <BackHeader title={'Fee report'} />
        <View style={styles.headerTitleContainer}>
          <View>
            <Text style={styles.secondaryTitle}>Fee Report</Text>
          </View>
...
export default PendingFeeReport;
