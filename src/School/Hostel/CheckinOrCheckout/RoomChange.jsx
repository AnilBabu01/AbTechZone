...
const RoomChange = () => {
        ...
        student?.length > 0 &&
          student?.map((item, index) => {
            ...
            StudentTableList[14].items.push({
              id: index,
              value: item?.hostal ? 'Active' : 'Disable',
            });
  ...
  return (
    <>
      <View style={{flex: 1}}>
        <BackHeader title={'Room Change'} icon={'person'} />
        <View style={styles.headerTitleContainer}>
          <View>
            <Text style={styles.secondaryTitle}>Room Change Management</Text>
          </View>
